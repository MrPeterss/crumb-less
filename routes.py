...
def initialize_data(mysql_engine_instance):
    """Initialize reviews, businesses, and similarity model"""
    global mysql_engine, reviews, businesses, sim
    
    mysql_engine = mysql_engine_instance
